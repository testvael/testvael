/******/ (() => {
  ...
  \***********************************/
      /***/ (
        ...
        $(".text-vcenter").mousemove(function (e) {
          var width = 1920 - $(document).width();
          var height = $(window).height();
          var pageX = e.pageX;
          var pageY = e.pageY;
          var amountMovedX = (pageX * -1) / 30 - width / 2 + "px";

          if (height >= 900) {
            var amountMovedY = (pageY * -1) / 30 + 250 + "px";
          } else if (height <= 800 && height > 700) {
            var amountMovedY = (pageY * -1) / 30 + 125 + "px";
          } else if (height <= 700) {
            var amountMovedY = (pageY * -1) / 30 + "px";
          } else {
            var amountMovedX = "center";
            var amountMovedY = "center";
          }

          if ($(document).width() > 1400) {
            $(this).css(
              "background-position",
              amountMovedX + " " + amountMovedY
            );
          } else {
            $(this).css("background-position", "center center");
          }
        });
        $(".nft-background .shapes").mousemove(function (e) {
          var pageX = e.pageX;
          var pageY = e.pageY;
          var amountMovedX = (pageX * -1) / 30;
          var amountMovedY = (pageY * -1) / 30 + 50;
          $(this).css("left", amountMovedX + "px ");
          $(this).css("right", -amountMovedX + "px ");
          $(this).css("top", amountMovedY + "px ");
          $(this).css("bottom", -amountMovedY + "px ");
        });
        $(".logo-with-shadow").mousemove(function (e) {
          var pageX = e.pageX;
          var pageY = e.pageY;
          var amountMovedX = (pageX * -1) / 30;
          var amountMovedY = (pageY * -1) / 30 - 188;
          $(this).css("left", amountMovedX + "px ");
          $(this).css("bottom", amountMovedY + "px ");
        });
        $(".header3 .menu a.go").click(function () {
          if (
  ...
  /******/ __webpack_require__.O(undefined, ["css/main"], () =>
